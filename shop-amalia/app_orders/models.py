...
class Order(models.Model):
    ...
    city = models.CharField(max_length=100, verbose_name=_("Город"), blank=True)
    address = models.CharField(max_length=1000, verbose_name=_("Адрес"), blank=True)
    ...
    def get_total_price(self):
        ...
        return sum(
            [
                order_item.product_amount * order_item.product_price
...
class OrderItems(models.Model):
    order = models.ForeignKey(
        "Order", on_delete=models.CASCADE, verbose_name=_("Заказ"), related_name="order"
    )
    ...
    product_amount = models.IntegerField(verbose_name=_("Количество товара"), default=1)
    product_price = models.FloatField(verbose_name=_("Цена товара"), default=0)
...
class DeliveryMethod(models.Model):
    title = models.CharField(max_length=200, verbose_name=_("Название"))
    description = models.TextField(max_length=1000, verbose_name=_("Описание"))
...
class PaymentStatuses(models.Model):
    title = models.CharField(max_length=200, verbose_name=_("Название"))
    priority = models.IntegerField(verbose_name=_("Приоритет"), default=0)
